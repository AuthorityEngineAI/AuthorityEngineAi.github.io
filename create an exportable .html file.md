...
Below is a complete, standalone HTML file you can copy into a new file named `index.html` and then export or upload anywhere you need. Save it with the `.html` extension.
